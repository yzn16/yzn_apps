    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
                                ...
                                Column(
                                  children: [
                                    Text(
                                      ...
                                      style: TextStyle(color: walletBalanceError ? Colors.red : Colors.green, fontFamily: AppThemeData.medium, fontSize: 18),
                                    ),
                                  ],
                                )
                              ],
          ...
          Visibility(
            visible: (xenditModel == null) ? false : xenditModel!.enable ?? false,
            child: Column(
              children: [
                const Divider(),
                CheckboxListTile(
                  onChanged: (bool? value) {
                    setState(() {
                      ...
                      orange = false;
                      selectedCardID = '';
                      paymentOption = "Pay Online Via".tr() + " Xendit";
                    });
                  },
                  value: xendit,
                  contentPadding: const EdgeInsets.all(0),
                  ...
                  title: Text('Xendit'.tr()),
                ),
              ],
            ),
          ),
          Visibility(
            visible: (orangeMoneyModel == null) ? false : orangeMoneyModel!.enable ?? false,
            child: Column(
              children: [
                const Divider(),
                CheckboxListTile(
                  onChanged: (bool? value) {
                    setState(() {
                      ...
                      selectedCardID = '';
                      paymentOption = "Pay Online Via".tr() + " OrangeMoney";
                    });
                  },
                  value: orange,
                  contentPadding: const EdgeInsets.all(0),
                  ...
                  title: Text('OrangeMoney'.tr()),
                ),
              ],
            ),
          ),
          Visibility(
            visible: (midTransModel == null) ? false : midTransModel!.enable ?? false,
            child: Column(
              children: [
                const Divider(),
                CheckboxListTile(
                  onChanged: (bool? value) {
                    setState(() {
                      ...
                      Midtrans = true;
                      selectedCardID = '';
                      paymentOption = "Pay Online Via".tr() + " Midtrans";
                    });
                  },
                  value: Midtrans,
                  contentPadding: const EdgeInsets.all(0),
